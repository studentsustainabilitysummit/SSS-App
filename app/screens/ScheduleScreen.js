...
const event1 = new InPersonEvent(1, Theme.Development, "The development of the first event", "Ben Marshall", new Date(2023, 1, 18, 12, 0), new Date(2023, 1, 18, 14, 0), location1);
